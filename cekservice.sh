...
echo -e "${CYAN}└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘\033[0m${NC}"
echo ""
echo -e "${BLUE}┌───────────── ◈ Service Information ◈ ─────────────┐\033[0m${NC}"
echo -e "${BLUE}│${NC} NGINX : ${NGINX} | FIREWALL : ${UFW} | MARZBAN : ${MARZ} ${GREEN}  |\033[0m${NC}"
echo -e "${BLUE}└───────────────────────────────────────────────────┘\033[0m${NC}"
echo ""
echo -e "${GREEN}┌━━━━━━━━━━━━━━ ◈ Special Thanks To ◈ ━━━━━━━━━━━━━┐\033[0m${NC}"
echo -e "${GREEN}|${NC} ➦ Built By  : https://t.me/EkoLing                |\033[0m${NC}"
echo -e "${GREEN}|${NC} ➦ Recode By : https://t.me/SaputraTech            |\033[0m${NC}"
echo -e "${GREEN}|${NC} ➦ Thanks To : https://t.me/ozargah_marzban        |\033[0m${NC}"
echo -e "${FREEN}└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘\033[0m${NC}"
echo ""
clear

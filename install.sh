...
curl -s -o /usr/local/bin/skt_backup https://raw.githubusercontent.com/raffasyaa/semvak/main/backup_marzban_v1.0.sh
...
chmod +x /usr/local/bin/skt_backup
# Display successful installation message
echo -e "\e[32mInstallation complete. You can now use the command 'skt_backup' to run the script.\e[0m"

# Run the script
echo -e "\e[33mRunning the script now...\e[0m"
exec /usr/local/bin/skt_backup
